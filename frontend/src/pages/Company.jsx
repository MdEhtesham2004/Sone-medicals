...
const Company = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Error in updating company details:', err);
    }
  };
            ...
            {companies.map((company, idx) => (
              <tr key={idx} className="border-t">
                ...
                <td className="p-3 space-x-2">
                  <button
                    className="bg-yellow-400 cursor-pointer hover:bg-yellow-500 text-white font-bold py-1 px-3 rounded"
