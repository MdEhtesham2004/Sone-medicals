    ...
    <div className="flex h-screen font-sans">
      ...
      <div className={`transition-all duration-300 ${sidebarOpen ? 'w-64' : 'w-16'} bg-gradient-to-br from-red-600 to-pink-700 text-white`}>
        ...
        <div className="mt-6 flex flex-col space-y-4 px-4">
          ...
          <Link to="/preview" className="hover:bg-white/10 py-2 px-4 rounded flex items-center gap-2">
            <FaUserTie /> {sidebarOpen && 'Preview Bill'}
          </Link>
      ...
      <div className="flex-1 bg-gray-100 p-6 overflow-auto">
        <Outlet /> {/* This shows Home, Bill, etc. based on current route */}
      </div>
    </div>
  );
};
